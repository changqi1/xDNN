...
//        *│      │*
//      ** │      │ **
void xdnn_sgemm_f32i8f32_quantize(bool transB, int N, int K, const float *B, int ldb,
        float quantization_rate, int8_t *quantizedB, int ldqb, float *scaleB, float *zeroB);

// To compute sgemm: C = alpha * A * B + beta * C
void xdnn_sgemm_f32i8f32(bool transA, bool transB, int M, int N, int K,
...
void xdnn_sgemm_f32i8f32_packb(bool transB, int N, int K, const int8_t *B, int ldb, int8_t *packedB);

// To compute sgemm: C = alpha * A * packedB + beta * C
// Note: there is no ldb, as B is packed in compact format
void xdnn_sgemm_f32i8f32_compute(bool transA, int M, int N, int K,
...
void xdnn_sgemm_f32i8f32_compute_silu(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
        float beta, float *C, int ldc);

// To compute sgemm w/ bias_add: C = alpha * A * packedB + beta * C + bias
void xdnn_sgemm_f32i8f32_compute_biasadd(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
        float beta, float *C, int ldc, const float *bias);

// To compute sgemm w/ bias_add: C = RELU(alpha * A * packedB + beta * C + bias)
void xdnn_sgemm_f32i8f32_compute_biasadd_relu(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
        float beta, float *C, int ldc, const float *bias);

// C = alpha * A * packedB + beta * C + bias + res
// ldres, residential matrix stride
void xdnn_sgemm_f32i8f32_compute_residential(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
...
// ldres, residential matrix stride
void xdnn_sgemm_f32i8f32_compute_resext(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
        float beta, float *C, int ldc, const float *bias, 
...
// ldres, residential matrix stride
void xdnn_sgemm_f32i8f32_compute_resmul(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
